...
class TemplateView : FrameLayout {
    ...
    fun getNativeAdView(): UnifiedNativeAdView? {
        return nativeAdView
    }
    ...
    fun setNativeAd(nativeAd: UnifiedNativeAd?) {
        try {
            ...
            val icon: Image = nativeAd.icon
            Log.d("prasit-store",store)
            Log.d("prasit-advertiser",advertiser)
            Log.d("prasit-headline",headline)
            Log.d("prasit-body",body)
