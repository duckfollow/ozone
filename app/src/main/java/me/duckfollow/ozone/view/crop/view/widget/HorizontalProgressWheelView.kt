package me.duckfollow.ozone.view.crop.view.widget
...
class HorizontalProgressWheelView : View {
    ...
    private var mLastTouchedPosition: Float = 0.toFloat()
    ...
    private var mTotalScrollDistance: Float = 0.toFloat()
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (i in 0 until linesCount) {
            ...
            canvas.drawLine(
                -deltaX + mCanvasClipBounds.left.toFloat() + (i * (mProgressLineWidth + mProgressLineMargin)).toFloat(),
