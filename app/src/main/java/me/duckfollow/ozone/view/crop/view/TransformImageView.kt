...
//import com.prasit.theboxshop.view.crop.callback.BitmapLoadCallback
//import com.prasit.theboxshop.view.crop.model.ExifInfo
import me.duckfollow.ozone.view.crop.util.BitmapLoadUtils
import me.duckfollow.ozone.view.crop.util.FastBitmapDrawable
...
open class TransformImageView @JvmOverloads constructor(
    ...
    companion object {
        ...
        const val TAG = "TransformImageView"

        const val RECT_CORNER_POINTS_COORDS = 8
        const val RECT_CENTER_POINT_COORDS = 2
        const val MATRIX_VALUES_COUNT = 9
    }
