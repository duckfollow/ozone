...
class UCropActivity : AppCompatActivity() {
    ...
    private fun setupViews(intent: Intent) {
        ...
        mActiveWidgetColor = intent.getIntExtra(
            UCrop.Options.EXTRA_UCROP_COLOR_WIDGET_ACTIVE,
    ...
    private fun initiateRootViews() {
        mUCropView = findViewById<View>(R.id.ucrop) as UCropView?
        ...
        mGestureCropImageView!!.cropAndSaveImage(
            ...
            object : BitmapCropCallback {
                ...
                override fun onBitmapCropped(
                    ...
                    Log.d("cropAndSave",resultUri.toString())
                    finish()
                }
