...
import me.duckfollow.ozone.util.Utils
...
class ArcProgress @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private val default_text_show:String
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
//        val sweepgradient = SweepGradient(135F, 135F, Color.parseColor("#FF7000"), Color.parseColor("#FFC82E"))

        var colorCustom:Int = finishedStrokeColor
...
//        val sweepgradient = SweepGradient(outX / 2f, -outX, mColors, null);
//        paint!!.setShader(sweepgradient)
    ...
    override fun onSaveInstanceState(): Parcelable? {
        ...
        bundle.putString(INSTANCE_TEXT_SHOW, textShow)
        return bundle
    }
    ...
    companion object {
        ...
        private val INSTANCE_TEXT_SHOW = "text_show"
    }
}
